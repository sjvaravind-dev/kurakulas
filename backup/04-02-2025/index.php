                ...
                <div class="row gy-3 mt-4">
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="100">
                        ...
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                            Our financial services offer expert guidance to help you grow and protect your wealth. We provide solutions to secure your financial future.
                            </p>
                            <br>
                            <div class="d-flex" style="float:right;padding-right: 10px;">
                                <!-- Adjusted button position -->
                                <a href="financial.php" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
                    ...
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="200">
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                                Investments help individuals and businesses grow wealth over time by allocating funds
                                into assets like share broking, D-mat, and mutual funds.
                            </p>
                            <br>
                            <div class="d-flex" style="float:right;padding-right: 10px;">
                    ...
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                                Insurance provides financial protection against unexpected events, offering coverage for
                                health, life, property, and businesses.
                            </p>
                            <br>
                            <div class="d-flex" style="float:right;padding-right: 10px;">
                                <a href="#" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
                    ...
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                            Our IT services provide solutions to optimize operations. From development to consulting, we ensure seamless technology integration.
                            </p>
                            <br>
                            <div class="d-flex" style="float:right;padding-right: 10px;">
                                <a href="#" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
                    ...
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                                Media services encompass content creation, digital marketing, broadcasting, and public
                                relations to connect brands with their audience.
                            </p>
                            <br>
                            <div class="d-flex" style="float:right;padding-right: 10px;">
                                <a href="#" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
                    ...
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                                Placement services help job seekers find the right roles and assist companies in hiring
                                qualified candidates. These services include recruitment,
                            </p>
                            <br>
                            <div class="d-flex" style="float:right;padding-right: 10px;">
                                <a href="#" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
                    ...
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                            NBFCs offer financial services like loans and investments without a banking license, providing flexible solutions for individuals and businesses.
                            </p>
                            <br>
                            <div class="d-flex" style="float:right;padding-right: 10px;">
                                <a href="#" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
                    ...
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                                Business Correspondents (BCs) act as intermediaries for banks, providing financial
                    ...
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                                Infrastructure and real estate drive economic growth by developing essential facilities,
                    ...
                    <div class="col-lg-7" data-aos="fade-up" data-aos-delay="300">
                        <div class="faq-container">
                            ...
                            <div class="faq-item faq-active">
                                <h3>Are there any processing fees for loans with Kurakula?</h3>
                                <div class="faq-content">
                                    <p>Yes, Kurakula may charge a processing fee for loan applications. The fee amount
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>Yes, Kurakula allows borrowers to make early repayments or part payments on their
                            ...
                            <div class="faq-item">
                                <h3>What services does Kurakula offer?</h3>
                                <div class="faq-content">
                                    <p>Kurakula offers a range of financial services, primarily focusing on loan
                            ...
                            <div class="faq-item">
                                <h3>Does Kurakula offer any special loan schemes or offers?</h3>
                                <div class="faq-content">
                                    <p>Yes, Kurakula periodically offers special loan schemes and promotions, such
                                        as:<br>
                            ...
                            <div class="faq-item">
                                <h3> What makes Kurakula different from other financial institutions</h3>
                                <div class="faq-content">
                                    <p>Kurakula stands out for several reasons:<br>
                                        Customer-Centric Approach: Kurakula emphasizes understanding customer needs and
                                        providing tailored solutions to help individuals and businesses access
                                        financing.<br>
                                        Competitive Interest Rates: Kurakula offers loan products with attractive
                                        interest rates, making borrowing more affordable.<br>
                                        Fast and Easy Processing: Kurakula has a streamlined loan approval process with
                            ...
                            <div class="faq-item">
                                <h3> How do I apply for a loan through Kurakula?</h3>
                                <div class="faq-content">
                                    <p>You can apply for a loan from Kurakula in several ways:<br>
