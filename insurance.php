        ...
        <section id="hero" class="hero section">
            ...
            <div class="container">
                        ...
                        <div class="swiper init-swiper">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="./assets/img/insurance/life.jpg" alt="Life Insurance">
                                </div>

                                <div class="swiper-slide">
                                    <img src="./assets/img/insurance/health.jpeg" alt="Health Insurance">
                                </div>

                                <div class="swiper-slide">
                                    <img src="./assets/img/insurance/general.jpeg" alt="General Insurance">
                                </div>
                            </div>
                ...
                <div class="section-title mt-5" data-aos="fade-up">
                    <h2>Insurance</h2>
                    <div><span class="description-title">Exploring the World of Insurance</span>
                    </div>
                </div>
                <!-- Slider Section -->
                <div class="row gy-3">
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="100">
                        ...
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                            Life insurance offers protection for loved ones, covering expenses and future costs. It provides peace of mind.
                            </p>
                            <br>
                    ...
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="200">
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <p class="description">
                            Health insurance covers medical expenses, providing financial protection against high healthcare costs and ensuring timely treatment.
                            </p>
                            <br>
                            <div class="d-flex" style="float:right;padding-right: 10px;">
                                <a href="#" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
                    ...
                    <div class="col-md-4 col-lg-4" data-aos="zoom-out" data-aos-delay="300">
                        <div class="icon-box text-center" style="padding: 10px; min-height: 250px;">
                            ...
                            <h4 class="title"><a href="#">GENERAL INSURANCE</a></h4>
                            <p class="description">
                            General insurance covers property, vehicle, health, and travel insurance, providing protection against unexpected financial losses.
                            </p>
                            <br>
                            <div class="d-flex" style="float:right;padding-right: 10px;">
                                <a href="#" class="read-more">Read More <i class="bi bi-arrow-right"></i></a>
